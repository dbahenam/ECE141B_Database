...
namespace ECE141 {
  ...
  public:
	...
	/*
	 Converts const char * and turns it into a 32 bit quantity (a hash).
	 Store this quantity into a header of data row, 
	 compare the hash of table name to hash of data row.
	 if they are the same then, that row belongs to that table.
	 */
